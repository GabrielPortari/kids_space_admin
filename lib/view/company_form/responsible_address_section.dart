...
class ResponsibleAddressSection extends StatelessWidget {
  ...
  const ResponsibleAddressSection({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Card(
      child: ExpansionTile(
        title: const Text('Endereço do responsável', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
